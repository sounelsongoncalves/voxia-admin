    ...
    <aside className="w-64 h-screen bg-surface-3 border-r border-surface-border flex flex-col fixed left-0 top-0 z-30">
      ...
      <div className="h-16 flex items-center px-6 border-b border-surface-border">
        {settings?.logo_url ? (
          ...
          <div className="w-8 h-8 bg-brand-primary rounded-lg mr-3 flex items-center justify-center">
            <span className="material-symbols-outlined text-bg-main font-bold">local_shipping</span>
          </div>
        )}
